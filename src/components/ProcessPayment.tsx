...
export function ProcessPayment(props: {
    ...
    /** ************************************************************************************************* **/
    /**                             TESTING BATCH ZERODEV TRANSACTIONS                                    **/
    /** ************************************************************************************************* **/
    // const { config: zeroConfig } = usePrepareContractBatchWrite({
    //     calls: [
    //         {
    //             address: contractAddresses[props.selectedToken!][chain?.id as keyof NetworkContract],
    //             abi: ERC20_CONTRACT_ABI,
    //             functionName: 'approve',
    //             args: [chain && sprintcheckoutContractAddressByNetwork[chain?.id], highAmountForApproval]
    //         }, {
    //             //@ts-ignore
    //             address: sprintcheckoutContractAddressByNetwork[chain?.id],
    //             abi: SPRINTCHECKOUT_CONTRACT_ABI,
    //             functionName: 'transferFrom',
    //             args: [props.merchantPublicAddress && props.selectedToken && chain && contractAddresses[props.selectedToken!][chain?.id as keyof NetworkContract], address, props.merchantPublicAddress, SPRINTCHECKOUT_FEE_ADDRESS,
    //                 merchantAmountRealBigNumber ? new BigNumber(merchantAmountRealBigNumber.toString()) : undefined, spcFeeToPayRealBigNumber ? new BigNumber(spcFeeToPayRealBigNumber.toString()) : undefined],
    ...
    // })
    //
    // const { writeAsync: batchMint, isLoading: isBatchLoadin, data } = useContractBatchWrite(zeroConfig)
    //
    ...
    if (enablePayCall && configSuccess) {
        ...
        // --------------------------------- TODO CANDIDE DRAFT CODE ---------------------------------
        // const calls = [
        //     {
        //         chainId: 5,
        //         from: account, // TODO is this the address or something else?
        //         calls: [ // TODO how to define approve and transfer from in calls array
        //             {
        //                 to: "0xED0704E34278560a220A1EDFd9A2972b181081Fc", // approve
        //                 value: "0x5AF3107A4000",
        //                 data: "0x",
        //                 gas: "0x76c0"
        //             },
        //             {
        //                 to: "0xf758D47a96685C1bb77223767F17D15497E610f3", // transfer from
        //                 value: "0x5AF3107A4000",
        //                 data: "0x",
        //                 gas: "0x76c0"
        //             }
        ...
        //
        //
        // // TODO add custom request to wallet_sendFunctionCallBundle and status
        // let response;
        // const client = createWalletClient({
        //     chain: mainnet,
        //     transport: custom({
        //         async request({ "wallet_sendFunctionCallBundle", calls }) { // TODO is the method a string?
        //             response = await customRpc.request("wallet_sendFunctionCallBundle", calls); // what is the customRpc class/component/whetever? and how to define it
        //             return response;
        //         }
        //     })
        // })
        //
        // //TODO how to do another request to the wallet_getBundleStatus method?
        // client.transport(custom({
        //     async request({ "wallet_getBundleStatus", responseStatus }) { // TODO is the method a string?
        //         const responseStatus = await customRpc.request("wallet_getBundleStatus", response); // what is the customRpc class/component/whetever? and how to define it
        //         return responseStatus;
        //     }
        // }));
        // --------------------------------- TODO END CANDIDE DRAFT CODE ---------------------------------
